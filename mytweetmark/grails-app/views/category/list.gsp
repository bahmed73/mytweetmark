                ...
                <table>
                    ...
                    <g:each in="${categoryInstanceList}" status="i" var="categoryInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean:categoryInstance, field:'status')}</td>
                        
                            <td>${fieldValue(bean:categoryInstance, field:'createTime')}</td>
                        
                            <td>${fieldValue(bean:categoryInstance, field:'orderBy')}</td>
