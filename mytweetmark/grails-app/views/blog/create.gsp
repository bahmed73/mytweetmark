...
<g:render template="/common/navBar"/>
        ...
        <div style="float:left;width:250px;text-align:center;">
	  			<h4>Quick Tip:</h4>
	  			<div style="margin:3px;">
	  			For design, you can add embedd HTML code in the description. Feel free to use heading, e.g. h1, h2, h3 and h4. Bold or italics. Enclose with valid HTML &lt;&gt;<br><br>  
	  			</div>
	  			</div>
	  		<br>
        </div>	
        ...
        <g:render template="/common/createBlog"/>
