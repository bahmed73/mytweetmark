...
//turn off grails errors
grails.views.gsp.sitemesh.preprocess=false 

// set per-environment serverURL stem for creating absolute links
environments {
    production {
        grails.serverURL = "http://www.mytweetmark.com"
    }
}
...
grails {
	   mail {
	     host = "smtp.gmail.com"
	     port = 465
	     username = "mytweetmark@gmail.com"
	     password = "formtek1"
...
//geoip.data.path="c:\\tools\\maxmind\\GeoIP.dat"
geoip.data.path="/usr/share/maxmind/GeoIP.dat"
geoip.data.cache=0
